  ...
  return (
    <div className={cn(
      ...
      <AnimatePresence mode="wait">
        {view === 'card' ? (
          <motion.div key="card-view" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="relative min-h-[60vh]">
            {history.length === 0 ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <div className="w-28 h-28 rounded-full bg-[#FFF8EC] border-2 border-border-main flex items-center justify-center mb-6">
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-muted-text">
                ...
                <p className="text-2xl font-bold text-ink mb-2">暂无历史记录</p>
                <p className="text-base text-muted-text">完成或取消任务后，记录会显示在这里</p>
              </div>
            ) : (
